...
#echo "TASKID: $taskid"
model="NORM17/dec400-emb200-enc400-adam_4e-04-do_ctx_0.3-do_emb_0.3-do_out_0.3-rc8e2f.best.bleu.ckpt"
#echo "MODEL: $model"
src_voc="NORM17/train_v2.vocab.vfr"
#echo "SRC_VOC: $src_voc"
trg_voc="NORM17/train_v2.vocab.fr"
